...
namespace AHD.ID3.Editor
{
    ...
    public class SettingsControlComparer : IComparer<SettingsControl>
    {
        bool AtoZ;
        public SettingsControlComparer(bool AtoZ)
        {
            this.AtoZ = AtoZ;
        }
        public int Compare(SettingsControl x, SettingsControl y)
        {
            if (AtoZ)
