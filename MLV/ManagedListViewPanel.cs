...
namespace MLV
{
    ...
    public partial class ManagedListViewPanel : Control
    {
        ...
        /// <summary>
        /// Indicate whether the user can drag and drop items
        /// </summary>
        public bool AllowItemsDragAndDrop = true;
        /// <summary>
        /// Indicate whether the user can reorder the columns.
        /// </summary>
        public bool AllowColumnsReorder = true;
        /// <summary>
        /// Indicate whether the sort mode value of a column get changed when the user click that column.
        /// </summary>
        ...
        /// <summary>
        /// Indicate whether to draw item highlight when the mouse over that item.
        /// </summary>
        ...
        {
            // base.OnPaintBackground(prevent);
        ...
        {
            base.OnMouseDown(e); if (buffered_columnsSize == 0) buffered_columnsSize = CalculateColumnsSize();
        ...
        {
            if (buffered_columnsSize == 0) buffered_columnsSize = CalculateColumnsSize();
            UpPoint = e.Location;
            base.OnMouseUp(e);
