...
{
    public partial class SynchronisedLyricsCodesPanel : Control
    {
        public SynchronisedLyricsCodesPanel()
        {
            InitializeComponent();
        ...
        public SynchronisedLyricsFrame SynchronisedLyricsFrame
        {
            get { return frame; }
            set
            {
